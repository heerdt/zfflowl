...
/**
 * @see https://github.com/mrclay/minify/blob/master/min/lib/Minify/CSS/UriRewriter.php
 */
class Paiva_Minify_CSS_UriRewriter {
     ...
     * @var string
     */
    protected static $className = 'Paiva_Minify_CSS_UriRewriter';
