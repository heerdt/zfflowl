...
/**
 * @see https://github.com/mrclay/minify/blob/master/min/lib/Minify/CSS/Compressor.php
 */
class Paiva_Minify_CSS_Compressor {
    /**
     * Minify a CSS string
     * 
     * @param string $css
    ...
    {
        $obj = new Paiva_Minify_CSS_Compressor($options);
